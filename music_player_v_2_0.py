...
class MusicPlayer: 
    ...
    def __init__(self):
        ...
        self.basic_frame = Frame(self.base ,bg=self.theme_colour, width=900  )
        ...
        self.slide_frame = Frame( self.base , bg=self.theme_colour, width=900 ) 
        self.slide_frame.pack(fill=X, expand =1, pady=0, padx=0)

        #creating a bottom frame 
        self.bottom_frame = Frame(self.base ,bg=self.theme_colour, width=900 )
        self.bottom_frame.pack( fill=X, side=BOTTOM, expand=1, anchor ="sw")
        self.bottom_frame.pack_propagate(0)
        
        prev_img  = ImageTk.PhotoImage(Image.open("C:/Users/Pranav/Pictures/png_images/music_player/transperent/previous.png"))
        next_img  = ImageTk.PhotoImage(Image.open("C:/Users/Pranav/Pictures/png_images/music_player/transperent/forward.png"))
        pause_img = ImageTk.PhotoImage(Image.open("C:/Users/Pranav/Pictures/png_images/music_player/transperent/play_pause.png"))
        forward_n = ImageTk.PhotoImage(Image.open("C:/Users/Pranav/Pictures/png_images/music_player/transperent/forward_n.png"))
        previous_n= ImageTk.PhotoImage(Image.open("C:/Users/Pranav/Pictures/png_images/music_player/transperent/previous_n.png"))
    ...
    def display_derrived_songs( self,event ): 
        ...
        #displaying the "no result found" if there are no matching songs available
    ...
    def get_all_music_from_the_folder(self):
        ...
        #creating a dataself.base for permenant storing the information
        ...
        #adding image for the add new songs button 
        #add_button_image = ImgaeTk.PhotoImage( Image.open("C:/") )
        ...
        for file in files: 
            for x in file:
                if(x!= "" ):   
                    lbl = Label(self.second_frame, text = x , font=("Itim 14")  , anchor="w" , width= 118 ,pady=6 , padx=10 )
                    lbl.bind("<Button-1>" , lambda e: self.getinfo(e) ) 
                    if( self.c_flag == 1 ):
                        lbl.configure(bg="#e3e3e3" , fg = "Black" , activeforeground = "Black" , activebackground="#e3e3e3" )
                        self.c_flag= 0 
